...
class _CreateTestDialogState extends State<CreateTestDialog> {
  ...
  MultiSelectController _categorycontroller = MultiSelectController();
  @override
              ...
              children: [
                Container(
                  ...
                  child: MultiSelectDropDown(
                    ...
                    // onOptionSelected: (selectedOptions) => selectedCategories =
                    //     _categorycontroller.selectedOptions.map((e) => e.value).toList(),
                    optionTextStyle: p2,
                ...
                Checkbox(
                    ...
                    onChanged: (newValue) {
                      setState(() {
                        ...
                        if (newValue == true) {
                          _categorycontroller
                              .setSelectedOptions(_categorycontroller.options);
